...
class HeaderAccord extends Component {
    render(){
        ...
        return(
            ...
            <div className = {classes.HeaderAccord}>
                ...
                {this.props.items.map((item) => {
                    ...
                    return (
                        ...
                        <button  key = {Math.random()} className={btnClass.join(" ")} type="button" data-toggle="collapse" data-target="#collapseExample" aria-expanded="false" aria-controls="collapseExample">
          ...
          <div style = {{minWidth : "100vw !important" , maxWidth: "100vw"}}  className="collapse" id="collapseExample">
